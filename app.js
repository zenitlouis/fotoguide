...
const ui={
 sk:{brand:'Fotografický zápisník',brandSub:'8 praktických ťahákov',nav:['Domov','Ťaháky','Ako sa učiť'],eyebrow:'Canon EOS 100D · praktická príručka',headline:'Menej tápať.<br><em>Viac fotografovať.</em>',intro:'Osem ťahákov, ktoré ti pomôžu rýchlejšie pochopiť fotoaparát, lepšie vidieť svet a fotografovať s väčšou istotou.',filters:['Všetko','Situácie','Základy'],chapterHead:'Obsah zápisníka',chapters:'8 kapitol',methodLabel:'Spôsob práce',methodTitle:'Ťahák nie je recept.<br>Je to štartovací bod.',steps:[['Pred fotením','Priprav sa, skontroluj nastavenia a pomenuj, čo chceš povedať.'],['V teréne','Používaj jeden ťahák, všímaj si svetlo a hľadaj lepšie uhly.'],['Po návrate','Vyber, uprav a pri každom zábere pomenuj, prečo funguje alebo nie.']],section:'Obsah zápisníka · 8 kapitol',open:'Otvorený ťahák',download:'Stiahnuť',prev:'← Predošlý',next:'Ďalší →',context:['Kedy ho použiť','Začni takto','Sleduj najmä','Úloha do terénu'],footer:'Malý fotoaparát. Veľké možnosti.',count:n=>`${n} ${n===1?'ťahák':'ťahákov'}`},
 en:{brand:'Photography field notes',brandSub:'8 practical cheat sheets',nav:['Home','Guides','How to learn'],eyebrow:'Canon EOS 100D · practical guide',headline:'Less guessing.<br><em>More photography.</em>',intro:'Eight visual guides to help you understand your camera faster, see light more clearly and photograph with greater confidence.',filters:['All','Situations','Foundations'],chapterHead:'Field notes index',chapters:'8 chapters',methodLabel:'Working method',methodTitle:'A guide is not a recipe.<br>It is a starting point.',steps:[['Before shooting','Prepare, check your settings and decide what you want the photograph to say.'],['In the field','Use one guide, observe the light and keep looking for a better angle.'],['Afterwards','Select, edit and name the specific reason why each photograph works—or does not.']],section:'Field notes · 8 chapters',open:'Open guide',download:'Download',prev:'← Previous',next:'Next →',context:['When to use it','Start here','Watch especially','Field exercise'],footer:'Small camera. Big possibilities.',count:n=>`${n} ${n===1?'guide':'guides'}`}
};
