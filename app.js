...
const meta={
 ...
 storytelling:{
  sk:{title:'Clona vo vyprávajúcej fotografii',subtitle:'Ostré popredie aj pozadie s objektívom 18–55 mm.',when:'Keď chceš v jednom zábere ukázať blízky predmet aj prostredie za ním.',start:'Nastav Av, 18 mm a f/11. Zaostri približne na 1–2 m a skontroluj čas; pre veľmi blízke popredie skús f/16.',watch:'Pri f/22 sa predlžuje čas a detaily môžu zmäknúť. Z ruky mier aspoň na 1/60 s; stabilizácia nezastaví pohyb ľudí.',task:'Odfoť tú istú scénu na 18 mm pri f/8, f/11 a f/22. Porovnaj ostrosť popredia, pozadia a čas.'},
  en:{title:'Aperture in storytelling photography',subtitle:'Keep foreground and background in focus with the 18–55 mm lens.',when:'When one frame should show a nearby subject and the setting behind it.',start:'Use Av, 18 mm and f/11. Focus about 1–2 m away and check shutter speed; try f/16 for a very close foreground.',watch:'At f/22 the shutter slows and fine detail may soften. Aim for at least 1/60 s handheld; IS cannot freeze moving people.',task:'Photograph the same scene at 18 mm and f/8, f/11 and f/22. Compare foreground, background and shutter speed.'}
 },
 lenses:{
  sk:{title:'Objektívy a crop faktor',subtitle:'Ohniská, full-frame ekvivalent pohľadu a praktické použitie.',when:'Keď si vyberáš objektív alebo chceš pochopiť, aký uhol záberu dostaneš na APS-C fotoaparáte Canon EOS 100D.',start:'Vynásob ohnisko crop faktorom 1,6. Napríklad 24 mm × 1,6 dá približne 38 mm full-frame ekvivalent pohľadu.',watch:'Objektív nemení svoje fyzické ohnisko. Prepočet porovnáva iba uhol záberu; hĺbku ostrosti a perspektívu ovplyvňujú aj vzdialenosť a clona.',task:'Nastav 18–55 mm postupne na 18, 24, 40 a 55 mm. Z jedného miesta odfoť rovnakú scénu a porovnaj, čo zostalo v zábere.'},
  en:{title:'Lenses and crop factor',subtitle:'Focal lengths, full-frame equivalent view and practical uses.',when:'Use this when choosing a lens or learning what angle of view a focal length gives on the Canon EOS 100D APS-C sensor.',start:'Multiply focal length by the 1.6 crop factor. For example, 24 mm × 1.6 gives roughly a 38 mm full-frame equivalent view.',watch:'The lens does not change its physical focal length. The conversion compares angle of view only; distance and aperture also affect perspective and depth of field.',task:'Set the 18–55 mm lens to 18, 24, 40 and 55 mm. Photograph the same scene from one position and compare what remains in the frame.'}
 }
};

const ui={
 sk:{brand:'Fotografický zápisník',brandSub:'9 praktických ťahákov',nav:['Domov','Ťaháky','Ako sa učiť'],eyebrow:'Canon EOS 100D · praktická príručka',headline:'Menej tápať.<br><em>Viac fotografovať.</em>',intro:'Deväť ťahákov, ktoré ti pomôžu rýchlejšie pochopiť fotoaparát, lepšie vidieť svet a fotografovať s väčšou istotou.',filters:['Všetko','Situácie','Základy'],chapterHead:'Obsah zápisníka',chapters:'9 kapitol',methodLabel:'Spôsob práce',methodTitle:'Ťahák nie je recept.<br>Je to štartovací bod.',steps:[['Pred fotením','Priprav sa, skontroluj nastavenia a pomenuj, čo chceš povedať.'],['V teréne','Používaj jeden ťahák, všímaj si svetlo a hľadaj lepšie uhly.'],['Po návrate','Vyber, uprav a pri každom zábere pomenuj, prečo funguje alebo nie.']],section:'Obsah zápisníka · 9 kapitol',open:'Otvorený ťahák',download:'Stiahnuť',prev:'← Predošlý',next:'Ďalší →',context:['Kedy ho použiť','Začni takto','Sleduj najmä','Úloha do terénu'],footer:'Malý fotoaparát. Veľké možnosti.',count:n=>`${n} ${n===1?'ťahák':'ťahákov'}`},
 en:{brand:'Photography field notes',brandSub:'9 practical cheat sheets',nav:['Home','Guides','How to learn'],eyebrow:'Canon EOS 100D · practical guide',headline:'Less guessing.<br><em>More photography.</em>',intro:'Nine visual guides to help you understand your camera faster, see light more clearly and photograph with greater confidence.',filters:['All','Situations','Foundations'],chapterHead:'Field notes index',chapters:'9 chapters',methodLabel:'Working method',methodTitle:'A guide is not a recipe.<br>It is a starting point.',steps:[['Before shooting','Prepare, check your settings and decide what you want the photograph to say.'],['In the field','Use one guide, observe the light and keep looking for a better angle.'],['Afterwards','Select, edit and name the specific reason why each photograph works—or does not.']],section:'Field notes · 9 chapters',open:'Open guide',download:'Download',prev:'← Previous',next:'Next →',context:['When to use it','Start here','Watch especially','Field exercise'],footer:'Small camera. Big possibilities.',count:n=>`${n} ${n===1?'guide':'guides'}`}
};
